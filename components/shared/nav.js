    ...
    <div id="logo-btn" style="display: flex;">
      <a href="#" id="logo-see-all">
        <span class="navbar-brand mb-0 h1">
            <img class="login-logo" src="https://user-images.githubusercontent.com/29741570/205346767-a182560c-64a6-4cfa-80b3-0d64cf998242.png" alt="Store logo" style="width: 50px; margin-left: 10px;"/>
        </span>
      </a>
      <div id="create_view">
